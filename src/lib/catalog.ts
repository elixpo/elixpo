...
export interface EcosystemProduct {
  slug: string; name: string; eyebrow: string; url: string; shortDescription: string;
...
export const ECOSYSTEM_PRODUCTS: EcosystemProduct[] = [
  {
    slug: "blogs", name: "LixBlogs", eyebrow: "Publishing platform", url: ELIXPO_LINKS.blog,
  ...
  {
    slug: "sketch", name: "LixSketch", eyebrow: "Visual collaboration", url: ELIXPO_LINKS.sketch,
  ...
  {
    slug: "portfolio", name: "Elixpo Portfolio", eyebrow: "Personal presence", url: ELIXPO_LINKS.portfolio,
  ...
  {
    slug: "search", name: "Elixpo Search", eyebrow: "AI-assisted discovery", url: ELIXPO_LINKS.search,
  ...
  {
    slug: "lixrl", name: "Lixrl", eyebrow: "Links and QR codes", url: ELIXPO_LINKS.urlShortener,
  ...
  {
    slug: "accounts", name: "Elixpo Accounts", eyebrow: "Identity and access", url: ELIXPO_LINKS.accounts,
  ...
  {
    slug: "packages", name: "Elixpo Packages", eyebrow: "Linux distribution", url: ELIXPO_LINKS.packages,
  ...
  {
    slug: "oreo", name: "Oreo Badge", eyebrow: "Open hardware and OreoOS", url: ELIXPO_LINKS.oreo, schemaType: "Product",
