    ...
    <section className="min-h-screen bg-black overflow-hidden relative flex flex-col justify-between select-none">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-12 text-center -translate-y-[8%] md:-translate-y-[5%] max-w-4xl mx-auto w-full">
        ...
        <motion.h2 
          ...
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white mb-8 tracking-tight font-normal leading-none"
          ...
          <AnimatePresence mode="wait">
            {!isSubmitted ? (
              ...
              >
                ...
                <div className="liquid-glass rounded-full pl-6 pr-2 py-2 flex items-center gap-3 w-full border border-white/5 shadow-2.5xl backdrop-blur-md">
                  <input
                    type="email"
                    value={email}
                    onChange={(e) => {
