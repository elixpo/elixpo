...
export function AboutSection() {
  ...
  return (
    ...
    >
      <div 
        className="bg-[#101010] border-t border-white/5 rounded-[1.5rem] md:rounded-[2.5rem] p-8 sm:p-12 md:py-12 md:px-16 max-w-6xl mx-auto shadow-2xl relative overflow-hidden"
      >
        ...
        {/* Side-by-side Layout from Artistic Flair template */}
        ...
        {/* Elixpo Ecosystem Labs section inside Prisma's workspace */}
        <motion.div
